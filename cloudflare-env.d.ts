/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 0cba1796d0454072cc00b12b8e71d56c)
...
declare namespace Cloudflare {
	interface Env {
		...
		STORAGE: R2Bucket;
		DB: D1Database;
		APPLICATION: Service<typeof import("./.open-next/worker").default>;
		ASSETS: Fetcher;
	}
}
